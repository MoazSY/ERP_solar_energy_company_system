...
Route::middleware('check_Agency_manager')->group(function () {
    ...
    Route::post('filter_most_amount_sales_company', [AgencyManagerController::class, 'filter_most_amount_sales_company'])->middleware(['check_agency_manager_active', 'check_agency_active']);
